    ...
    <>
      <header className="mb-8">
        ...
        <p className="text-[15px] leading-relaxed text-wuko-text">
          Add Wuko&apos;s shadcn-style component registry to your project.
          Components land directly in your codebase, themed by Wuko&apos;s
          role tokens, ready to customize.
        </p>
      </header>

      <InfoCallout title="Prerequisites">
        Wuko requires <code>Tailwind v4</code> (the <code>@theme inline</code>{" "}
      ...
      <p className="mb-4 text-[14px] leading-relaxed text-wuko-text">
        Wuko components are distributed through the shadcn CLI. Run{" "}
      ...
      <H2 id="set-up-tokens">2. Set up Wuko&apos;s role tokens</H2>
      <p className="mb-4 text-[14px] leading-relaxed text-wuko-text">
        Paste the block below into your <code>app/globals.css</code> (or
        wherever you import Tailwind). It defines Wuko&apos;s public role
      ...
      <p className="mt-3 text-[13px] leading-relaxed text-wuko-text-muted">
        Without this block, Wuko components install but render with undefined
      ...
      <p className="mt-3 text-[13px] leading-relaxed text-wuko-text-muted">
        Wuko&apos;s registry is currently served from{" "}
        <code>localhost:3000</code> during development. Replace the URL with
        the production origin once Wuko is publicly hosted.
      </p>
      ...
      <InfoCallout>
        Build a real theme toggle later, or copy Wuko&apos;s pattern from{" "}
